...
public class IronPlates {
    ...
    @HadronCube.WithStairsAndSlabs(id = IRON_PLATES_ID, texture = IRON_PLATES_ID)
    ...
    @HadronCube.WithStairsAndSlabs(id = RUSTY_IRON_PLATES_ID, texture = RUSTY_IRON_PLATES_ID)

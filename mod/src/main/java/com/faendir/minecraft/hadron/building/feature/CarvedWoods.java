...
public class CarvedWoods {
    ...
    public static Block CARVED_OAK_WOOD = new Block(Block.Properties.from(Blocks.OAK_PLANKS)).setRegistryName(CARVED_OAK_WOOD_ID);
    ...
    public static Block CARVED_ACACIA_WOOD = new Block(Block.Properties.from(Blocks.ACACIA_PLANKS)).setRegistryName(CARVED_ACACIA_WOOD_ID);
    ...
    public static Block CARVED_BIRCH_WOOD = new Block(Block.Properties.from(Blocks.BIRCH_PLANKS)).setRegistryName(CARVED_BIRCH_WOOD_ID);
    ...
    public static Block CARVED_DARK_OAK_WOOD = new Block(Block.Properties.from(Blocks.DARK_OAK_PLANKS)).setRegistryName(CARVED_DARK_OAK_WOOD_ID);
    ...
    public static Block CARVED_JUNGLE_WOOD = new Block(Block.Properties.from(Blocks.JUNGLE_PLANKS)).setRegistryName(CARVED_JUNGLE_WOOD_ID);
    ...
    public static Block CARVED_SPRUCE_WOOD = new Block(Block.Properties.from(Blocks.SPRUCE_PLANKS)).setRegistryName(CARVED_SPRUCE_WOOD_ID);

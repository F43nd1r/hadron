...
public class StoneBricks {
    ...
    @Brick(id = ANDESITE_BRICKS_ID, texture = Hadron.ID + ":block/" + ANDESITE_BRICKS_ID, material = "minecraft:polished_andesite")
    ...
    @Brick(id = DIORITE_BRICKS_ID, texture = Hadron.ID + ":block/" + DIORITE_BRICKS_ID, material = "minecraft:polished_diorite")
    ...
    @Brick(id = GRANITE_BRICKS_ID, texture = Hadron.ID + ":block/" + GRANITE_BRICKS_ID, material = "minecraft:polished_granite")
    ...
    @Recipe(id = "{id}", pattern = {"xx", "xx"}, keys = @Recipe.Key(key = "x", value = "{material}"), count = 4)
    @BlockState(id = "{id}", variants = @BlockState.Variant(id = "", model = @BlockState.Model(Hadron.ID + ":block/{id}")))

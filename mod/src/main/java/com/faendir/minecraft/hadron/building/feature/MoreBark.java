...
public class MoreBark {
    @Bark(id = "minecraft:oak_wood", texture = "minecraft:block/oak_log")
    public static final Block OAK_BARK = Blocks.OAK_WOOD;

    @Bark(id = "minecraft:spruce_wood", texture = "minecraft:block/spruce_log")
    public static final Block SPRUCE_BARK = Blocks.SPRUCE_WOOD;

    @Bark(id = "minecraft:birch_wood", texture = "minecraft:block/birch_log")
    public static final Block BIRCH_BARK = Blocks.BIRCH_WOOD;

    @Bark(id = "minecraft:jungle_wood", texture = "minecraft:block/jungle_log")
    public static final Block JUNGLE_BARK = Blocks.JUNGLE_WOOD;

    @Bark(id = "minecraft:acacia_wood", texture = "minecraft:block/acacia_log")
    public static final Block ACACIA_BARK = Blocks.ACACIA_WOOD;

    @Bark(id = "minecraft:dark_oak_wood", texture = "minecraft:block/dark_oak_log")

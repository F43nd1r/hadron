...
public class SandyBricks {
    ...
    @HadronCube.WithStairsAndSlabs(id = SANDY_BRICKS_ID, texture = SANDY_BRICKS_ID)
    @Recipe.Shapeless(id = SANDY_BRICKS_ID, ingredients = {"minecraft:bricks", "minecraft:sand"})
